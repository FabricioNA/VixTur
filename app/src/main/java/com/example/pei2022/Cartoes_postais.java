...
public class Cartoes_postais extends AppCompatActivity {
    ...
    MapView mapViewCP, mapViewCJ, mapViewMM, mapViewPA, mapViewPC, mapViewPB, mapViewPS, mapViewPF, mapViewFG, mapViewCM;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(Cartoes_postais.this).load(URLfg).placeholder(R.drawable.progress_bar).diskCacheStrategy(DiskCacheStrategy.AUTOMATIC).into(imageViewFG);
        Glide.with(Cartoes_postais.this).load(URLcm).placeholder(R.drawable.progress_bar).diskCacheStrategy(DiskCacheStrategy.AUTOMATIC).into(imageViewCM);
